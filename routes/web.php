...
Route::group(['middleware' => ['adminAuth']], function()
{
    ...
    Route::get('/salesBailed', [MainController::class,'salesB']);
    Route::post('addsales', [MainController::class,'sales']);
    Route::post('bailedsales', [MainController::class,'saleBailed']);
    Route::delete('salesDelete/{id}', [ManageController::class,'deleteSales']);
    Route::delete('salesBailedDelete/{id}', [ManageController::class,'deleteSalesBailed']);
    ...
    Route::get('salesBailedFilter', [MainController::class,'salesBailedFilter']);
